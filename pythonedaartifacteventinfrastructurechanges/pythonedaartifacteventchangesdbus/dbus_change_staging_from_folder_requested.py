"""
pythonedaartifacteventinfrastructurechanges/pythonedaartifacteventchangesdbus/dbus_change_staging_from_folder_requested.py

This file defines the DbusChangeStagingFromFolderRequested class.

Copyright (C) 2023-today rydnr's pythoneda-artifact-event-infrastructure/changes
...
from pythonedaartifacteventinfrastructurechanges.pythonedaartifacteventchangesdbus import DBUS_PATH
...
class DbusChangeStagingFromFolderRequested(ServiceInterface):
    ...
    def parse_pythonedaartifactchanges_ChangeStagingFromFolderRequested(
        ...
        """
        print(f"Parsing {message} for ChangeStagingFromFolderRequested")
